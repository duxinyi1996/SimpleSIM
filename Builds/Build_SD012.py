...
def Build_012(object, lead_number=0):
    object.sub_size_x = 10000
    object.sub_size_y = 10000
    ...
    def DC_lines(object, x, y, dy, lead_number):
        ...
        for i in range(lead_number):
            ...
            object.single_filter(x_list=[x1, x1, x2, x2, x2],
    ...
    object.single_filter(x_list=[1269,2034,2034,2034],y_list=[-1079,-1079,-1743,-1943])
